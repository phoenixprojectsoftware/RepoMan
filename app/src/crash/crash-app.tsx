...
export class CrashApp extends React.Component<ICrashAppProps, ICrashAppState> {
  ...
  private renderTitle() {
    const message =
      this.state.type === 'launch'
        ? 'PhoenixLink failed to launch'
        : 'PhoenixLink encountered an error'
  ...
  private renderDescription() {
    if (this.state.type === 'launch') {
      return (
        <p>
          PhoenixLink encountered a catastrophic error that prevents it from
          launching. This has been reported to the team, but if you encounter
          this repeatedly please report this issue to the PhoenixLink{' '}
      ...
      return (
        <p>
          PhoenixLink has encountered an unrecoverable error and will need to
          restart. This has been reported to the team, but if you encounter this
          repeatedly please report this issue to the PhoenixLink{' '}
          <LinkButton uri={issuesUri}>issue tracker</LinkButton>.
        </p>
      )
    }
