...
export const BrowserRedirectMessage =
  "Your browser will redirect you back to PhoenixLink once you've signed in. If your browser asks for your permission to launch PhoenixLink please allow it to."
