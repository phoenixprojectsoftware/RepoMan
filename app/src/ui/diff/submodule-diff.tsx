...
export class SubmoduleDiff extends React.Component<ISubmoduleDiffProps> {
  ...
  private renderOpenSubmoduleAction() {
    ...
    return (
      <span>
        <SuggestedAction
          title="Open this submodule on PhoenixLink"
          description="You can open this submodule on PhoenixLink as a normal repository to manage and commit any changes in it."
